<div class="text-center flex flex-col gap-8">
	...
	<p class="text-xl">Index for all of the legal articles. The link to this page can be found in the footer of the YARG website.</p>
</div>

<ul class="py-8 list-disc list-inside text-xl">
