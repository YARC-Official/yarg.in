...
export const milisToDisplayLength = (length, long = false) => {
	if (long) {
...
export const isConsideredNewRelease = (releaseDate, newestInSetlist) => {
...
export const distanceFromToday = (initial) => {
